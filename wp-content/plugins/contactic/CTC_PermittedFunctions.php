...
class CTC_PermittedFunctions {
    ...
    public function init() {
        $this->permittedFunctions = CTC_PermittedFunctions::$defaultPermitted;
    }

    public static function getInstance() {
        static $inst = null;
        if ($inst === null) {
            $inst = new CTC_PermittedFunctions();
            $inst->init();
        }
        return $inst;
    }
...
/**
 * A function wrapper to register function names in a CTC_PermittedFunctions singleton
 * @param $function_name
 */
function cfdb_register_function($function_name) {
    CTC_PermittedFunctions::getInstance()->addPermittedFunction($function_name);
}
