...
//require_once('CTC_Transform.php');
require_once('CTC_DataIteratorDecorator.php');

class CTC_TransformByClassIterator extends CTC_DataIteratorDecorator {
    ...
    /**
     * @param $transformObject CTC_Transform interface but allow for duck-typing
     */
