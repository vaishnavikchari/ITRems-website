...
class CTC_ExportToHtmlTable extends CTC_ExportBase implements CTC_Export {
     ...
     */
    public function export($formName, $options = null, $get_columns = false) {
        ...
        if ($get_columns){
            return $this->dataIterator->getDisplayColumns();
        }
        ...
        if ($this->isFromShortCode) {
            ...
            if ($printScripts) {
                ...
                wp_enqueue_script('datatables', $pluginUrl . 'assets/plugins/DataTables/media/js/jquery.dataTables.min.js', array('jquery'));
                wp_print_scripts('datatables');
            }
            if ($printStyles) {
                $pluginUrl = plugins_url('/', __FILE__);
                wp_enqueue_style('datatables-demo', $pluginUrl .'assets/plugins/DataTables/media/css/demo_table.css');
                wp_enqueue_style('jquery-ui.css', $pluginUrl . 'assets/plugins/jquery-ui/jquery-ui.css');
        ...
        if ($this->htmlTableClass == $this->defaultTableClass && !CTC_ExportToHtmlTable::$wroteDefaultHtmlTableStyle) {
            ?>
            <style type="text/css">
            ...
            <?php
            CTC_ExportToHtmlTable::$wroteDefaultHtmlTableStyle = true;
        }
