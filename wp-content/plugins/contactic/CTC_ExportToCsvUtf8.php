...
require_once('CTC_ShiftJisConverter.php');

class CTC_ExportToCsvUtf8 extends CTC_ExportBase implements CTC_Export {
    ...
    /**
     * CTCExportToCsvUtf8 constructor.
     */
    public function __construct() {
        parent::__construct();
        $this->shiftJis = new CTC_ShiftJisConverter();
    }
