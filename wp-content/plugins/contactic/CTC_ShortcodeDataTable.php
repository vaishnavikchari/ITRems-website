...
require_once('CTC_ShortCodeScriptLoader.php');

class CTC_ShortcodeDataTable extends CTC_ShortCodeScriptLoader {
...
//        wp_register_script('datatables', 'http://www.datatables.net/release-datatables/media/js/jquery.dataTables.js', array('jquery'), false, true);
        wp_enqueue_script('datatables',  plugins_url('/', __FILE__) . 'assets/plugins/DataTables/media/js/jquery.dataTables.min.js', array('jquery'));
