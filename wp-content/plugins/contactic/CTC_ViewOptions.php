...
class CTC_ViewOptions extends CTC_View {
    ...
    public function outputOptions($plugin) {
        ...
        <div class="cfdb_options_div">
            <div id="cfdb_options_tabs" style="margin-right:20px">
                <ul>
                    <li>
    ...
    public function outputFooter() {
        ?>
                ...
                <p class="submit" style="text-align: center">
                    <input style="height:auto !important;padding: 8px 16px" type="submit" class="button-primary" value="<?php echo esc_attr(__('Save Changes', 'contact-form-7-to-database-extension')); ?>"/>
                </p>
            </form>
        </div>
        <?php
