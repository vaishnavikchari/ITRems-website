...
require_once('CTC_FunctionEvaluator.php');

abstract class CTC_ParserBase {

    /**
     * @var CTC_FunctionEvaluator
     */
    var $functionEvaluator;

    /**
     * @var CTC_PermittedFunctions
     */
    var $permittedFilterFunctions;

    public function __construct() {
        $this->functionEvaluator = new CTC_FunctionEvaluator();
    }

    public abstract function parse($string);

    /**
     * @param  $converter CTCValueConverter
     * @return void
     */
    ...
    /**
     * @param $cFDBPermittedFilterFunctions CTC_PermittedFunctions
     * @return void
     */
